...
sudo apt-get install subversion git python build-essential python-setuptools libboost-python-dev libboost-thread-dev python-dev git-core autoconf libtool python-pip
